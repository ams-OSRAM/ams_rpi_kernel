...
// 400_400_30fps_10b_1lane
// Taken from ams_jetcis/sensors/mira016/config_files/test_sequence.txt
static const struct mira016_reg full_400_400_30fps_10b_1lane_reg_pre_soft_reset[] = {
	//Base Configuration
	{57344,  0},
	{57726,  1},
	{57344,  0},
...
static const struct mira016_reg full_400_400_30fps_10b_1lane_reg_post_soft_reset[] = {
	// Release Soft Reset
	{57344,  0},
	{57353,  1},
	{8495,  1},
...
static const struct mira016_mode supported_modes[] = {
	{
		...
		.reg_list_pre_soft_reset = {
			.num_of_regs = ARRAY_SIZE(full_400_400_30fps_10b_1lane_reg_pre_soft_reset),
			.regs = full_400_400_30fps_10b_1lane_reg_pre_soft_reset,
		},
		.reg_list_post_soft_reset = {
			.num_of_regs = ARRAY_SIZE(full_400_400_30fps_10b_1lane_reg_post_soft_reset),
			.regs = full_400_400_30fps_10b_1lane_reg_post_soft_reset,
		},
		.vblank = 2866,
		.hblank = MIRA016_HBLANK_30FPS, // TODO
		.bit_depth = 10,

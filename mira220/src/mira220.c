...
#define MIRA220_XCLR_MIN_DELAY_US		2000
#define MIRA220_XCLR_DELAY_RANGE_US		10
...
static const struct mira220_reg full_2_24_mp_30_fps_mode[] = {
	// 8-bit sensor output
	{ MIRA220_BIT_DEPTH_REG, MIRA220_BIT_DEPTH_8_BIT },
	{ MIRA220_CSI_DATA_TYPE_REG, MIRA220_CSI_DATA_TYPE_8_BIT },
	// Exposure time controled via register with no delay
	{ MIRA220_EXT_EXP_PW_SEL_REG, MIRA220_EXT_EXP_PW_SEL_USE_REG },
	{ MIRA220_EXT_EXP_DELAY_HI_REG, 0 },
	{ MIRA220_EXT_EXP_DELAY_LO_REG, 0 },
	// Set start coordinates
	{ MIRA220_HSTART_LO_REG, 0 },
	{ MIRA220_HSTART_HI_REG, 0 },
	{ MIRA220_VSTART1_LO_REG, 0 },
	{ MIRA220_VSTART1_HI_REG, 0 },
	// VSIZE1 = 0x578 = 1400
	{ MIRA220_VSIZE1_HI_REG, 0x05 },
	{ MIRA220_VSIZE1_LO_REG, 0x78 },
	// HSIZE = 0x320 = 800 (1600 / 2)
	{ MIRA220_HSIZE_HI_REG, 0x03 },
	{ MIRA220_HSIZE_LO_REG, 0x20 },
	// VBLANK (30 fps) = 0xb32 = 2866
	{ MIRA220_VBLANK_HI_REG, 0x0b },
	{ MIRA220_VBLANK_LO_REG, 0x32 },
	// MIPIHSIZE = 0x640 = 1600
	{ MIRA220_MIPI_HSIZE_HI_REG, 0x06 },
	{ MIRA220_MIPI_HSIZE_LO_REG, 0x40 },
	// Configure row length to minimum value (to allow high frame rates if needed)
	{ MIRA220_ROW_LENGTH_LO_REG, (MIRA220_MIN_ROW_LENGTH & 0xFF) },
	{ MIRA220_ROW_LENGTH_HI_REG, (MIRA220_MIN_ROW_LENGTH >> 8) },

	{ MIRA220_HFLIP_REG, MIRA220_HFLIP_DISABLE_MIRROR },
	{ MIRA220_VFLIP_REG, MIRA220_VFLIP_DISABLE_FLIP },
	{ MIRA220_BIT_ORDER_REG, MIRA220_BIT_ORDER_NORMAL },
	// 1.5 Gbps MIPI CSI configuration as defined in DS000642 (section 9.3.5)
	{ MIRA220_MIPI_SOFT_RESET_REG, MIRA220_MIPI_SOFT_RESET_DPHY },
	{ 0x5086, 0x02 },
	{ 0x5087, 0x4E },
	{ 0x5088, 0x00 },
	{ 0x5090, 0x00 },
	...
	{ 0x5097, 0x00 },
	{ 0x5098, 0x11 },
	{ MIRA220_MIPI_SOFT_RESET_REG, MIRA220_MIPI_SOFT_RESET_NONE },
	{ MIRA220_FSYNC_EOF_MAX_CTR_LO_REG, 0x6C },
	{ MIRA220_FSYNC_EOF_MAX_CTR_HI_REG, 0x07 },
	{ MIRA220_FSYNC_EOF_VEND_ST_LO_REG, 0x7E },
	{ MIRA220_FSYNC_EOF_VEND_ST_HI_REG, 0x06 },
	{ 0x20AC, 0x7E },
	{ 0x20AD, 0x06 },
	{ MIRA220_FSYNC_EOF_HSTART_EMB_ST_LO_REG, 0xC8 },
	{ MIRA220_FSYNC_EOF_HSTART_EMB_ST_HI_REG, 0x00 },
	{ 0x20B4, 0xC8 },
	{ 0x20B5, 0x00 },
	{ MIRA220_FSYNC_EOF_DSTART_EMB_ST_LO_REG, 0x1E },
	{ MIRA220_FSYNC_EOF_DSTART_EMB_ST_HI_REG, 0x04 },
	{ 0x20B6, 0x1E },
	{ 0x20B7, 0x04 },
	{ MIRA220_FSYNC_EOF_HEND_EMB_ST_LO_REG, 0xD4 },
	{ MIRA220_FSYNC_EOF_HEND_EMB_ST_HI_REG, 0x04 },
	{ 0x20B8, 0xD4 },
	{ 0x20B9, 0x04 },

	// Configure default values for dynamic parameters
	{ MIRA220_EXP_TIME_LO_REG, (MIRA220_DEFAULT_EXPOSURE & 0xff) },
	{ MIRA220_EXP_TIME_HI_REG, (MIRA220_DEFAULT_EXPOSURE >> 8) },
	{ MIRA220_ANALOG_GAIN_REG, MIRA220_ANALOG_GAIN_DEFAULT },
};
...
static int mira220_open(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh)
{
	...
	try_crop->top = MIRA220_PIXEL_ARRAY_TOP;
	try_crop->left = MIRA220_PIXEL_ARRAY_LEFT;
	try_crop->width = MIRA220_PIXEL_ARRAY_WIDTH;
	try_crop->height = MIRA220_PIXEL_ARRAY_HEIGHT;
	...
	if (fmt->pad == IMAGE_PAD) {
		...
		if (fmt->which == V4L2_SUBDEV_FORMAT_TRY) {
			...
			*framefmt = fmt->format;
			...
			max_exposure = mira220_calculate_max_exposure_time(MIRA220_MIN_ROW_LENGTH,
									   mira220->mode->height,
									   mira220->mode->vblank);
			default_exp = MIRA220_DEFAULT_EXPOSURE > max_exposure ? max_exposure : MIRA220_DEFAULT_EXPOSURE;
			rc = v4l2_ctrl_modify_range(mira220->exposure,
			...
			rc = v4l2_ctrl_s_ctrl(mira220->vblank, mira220->mode->vblank);
			if (rc) {

...
#define MIRA050_OTP_CAL_VALUE_MAX 3000 // TODO
...
static int mira050_write_analog_gain_reg(struct mira050 *mira050, u8 gain)
{
	...
	else if (mira050->bit_depth == 10)
	{
		if (gain < ARRAY_SIZE(fine_gain_lut_10bit_hs_4x))
		{
			...
			u16 otp_cal_val = 39; // TODO FIXME mira050->otp_cal_val;
			u8 target_black_level = 16;
			u16 adc_offset = 1540;
			u16 digital_gain = 16 / (gdig_amp + 1);
			u16 offset_clipping = 28;
			...
			/* Avoid negative offset_clipping value. */
			int estimated_offset = (int)((otp_cal_val + 2) * analog_gain / (int)(gdig_amp + 1) / 256 - 2);

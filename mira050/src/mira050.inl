...
// 50 fps
#define MIRA050_MIN_VBLANK_60 15900
// 50 fps
#define MIRA050_MIN_VBLANK_120 7560
...
#define MIRA050_OTP_CAL_VALUE_DEFAULT 2400
#define MIRA050_OTP_CAL_VALUE_MIN 2399
#define MIRA050_OTP_CAL_VALUE_MAX 2401 //TODO 
...
// Taken from generated_api\CSP_opt3_12-bit mode_anagain1_60fps_exp2000us_datarate_1500.0_mclk_24.0.txt
...
// generated_api\CSP_opt3_8-bit mode_anagain16_60fps_exp2000us_datarate_1500.0_mclk_24.0.txt
...
static int mira050_set_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	if (ctrl->id == V4L2_CID_VBLANK)
	{
		...
		exposure_max = mira050_calculate_max_exposure_time(MIRA050_MIN_ROW_LENGTH,
														   mira050->mode->height,
														   ctrl->val);
		exposure_def = (exposure_max < MIRA050_DEFAULT_EXPOSURE_US) ? exposure_max : MIRA050_DEFAULT_EXPOSURE_US;

...
#define MIRA130_ANALOG_GAIN_REG			0x400A
#define MIRA130_ANALOG_GAIN_MIN			1
#define MIRA130_ANALOG_GAIN_MAX			1 /* Fixed analog gain to 1, to avoid unexpected behavior. */
#define MIRA130_ANALOG_GAIN_STEP		1
#define MIRA130_ANALOG_GAIN_DEFAULT		MIRA130_ANALOG_GAIN_MIN
...
static int mira130_write_analog_gain_reg(struct mira130 *mira130, u8 gain) {
	...
	if ((gain < MIRA130_ANALOG_GAIN_MIN) || (gain > MIRA130_ANALOG_GAIN_MAX)) {
		return -EINVAL;
	}

	reg_value = (u8)(8 / gain);

	ret = mira130_write(mira130, MIRA130_ANALOG_GAIN_REG, reg_value);
...
static int mira130_init_controls(struct mira130 *mira130)
{
	...
	mira130->gain = v4l2_ctrl_new_std(ctrl_hdlr, &mira130_ctrl_ops, V4L2_CID_ANALOGUE_GAIN,
			  MIRA130_ANALOG_GAIN_MIN, MIRA130_ANALOG_GAIN_MAX,
			  MIRA130_ANALOG_GAIN_STEP, MIRA130_ANALOG_GAIN_DEFAULT);

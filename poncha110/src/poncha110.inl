...
#define PONCHA110_ROW_LENGTH 2710 // 1-4 gain
...
#define PONCHA110_MIN_VBLANK 50  // 23 fps
#define PONCHA110_MAX_VBLANK 30000	   //1000000
#define PONCHA110_DEFAULT_VBLANK_30 148  // 200 fps
...
static const struct poncha110_reg full_10b_2lane_reg_pre_soft_reset[] = {
	//POLAR_PIX
	{ 0x0106, 0x02 },
	{ 0x0107, 0x83 },
	//POLAR_ANACOL
...
static const struct poncha110_mode supported_modes[] = {
	{
		...
		.reg_list_pre_soft_reset = {
			.num_of_regs = ARRAY_SIZE(full_10b_2lane_reg_pre_soft_reset),
			.regs = full_10b_2lane_reg_pre_soft_reset,
		},

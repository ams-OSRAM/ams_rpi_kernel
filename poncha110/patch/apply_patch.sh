...
INSERT_IF_NOT_EXIST="CONFIG_VIDEO_PONCHA110=m"
...
INSERT_IF_NOT_EXIST="config VIDEO_PONCHA110"
insert_file_A_into_file_B_before_pattern_C_if_pattern_D_does_not_exist "$INSERT_FILE" "$TARGET_FILE" "$INSERT_BEFORE" "$INSERT_IF_NOT_EXIST" 
...
INSERT_IF_NOT_EXIST="poncha110.o"
insert_file_A_into_file_B_before_pattern_C_if_pattern_D_does_not_exist "$INSERT_FILE" "$TARGET_FILE" "$INSERT_BEFORE" "$INSERT_IF_NOT_EXIST" 
...
INSERT_IF_NOT_EXIST="poncha110.dtbo"
insert_file_A_into_file_B_before_pattern_C_if_pattern_D_does_not_exist "$INSERT_FILE" "$TARGET_FILE" "$INSERT_BEFORE" "$INSERT_IF_NOT_EXIST" 
